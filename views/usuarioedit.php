                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="hidden" name="codusuario" value="<?= $data["codusuario"]?>">
                                            <input type="text" name="dni" class="form-control" id="fordni" value="<?= $data["dni"]?>" placeholder="Documento Nacional de Identidad">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre" class="form-control" id="fornombre" value="<?= $data["nombres"]?>" placeholder="Nombres Completos">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="forape">Apellidos <span class="text-danger">*</span></label>
                                        <input type="text" name="apellido" class="form-control" id="forape" value="<?= $data["apellidos"]?>" placeholder="Apellidos Completos">
                                    </div>
                                </div>
                                <!-- <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="forape">Contaseña</label>
                                        <input type="password" name="contraseña" class="form-control" id="forape" value="" placeholder="Contaseña">
                                    </div>
                                </div> -->
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="forape">Celular</label>
                                        <input type="number" name="telefono_usuario" class="form-control" id="forape" value="<?= $data["numcelular"]?>" placeholder="Celular">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="forape">Correo</label>
                                        <input type="email" name="correo_usuario" class="form-control" id="forape" value="<?= $data["correo"]?>" placeholder="Correo">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="forape">Direccion</label>
                                        <input type="direccion" name="direccion_usuario" class="form-control" id="forape" value="<?= $data["direccion"]?>" placeholder="Direccion">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="idperfil_usuario">
                                            ...
                                            foreach ($Perfiles as $item) {
                                                if ( $data["codperfil"]["codperfil"] == $item['codperfil'] ) {
                                                    echo '<option value="'.$item['codperfil'].'" selected >'.$item['nombres'].'</option>';
                                                }else{
